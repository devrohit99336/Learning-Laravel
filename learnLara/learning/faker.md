...
**Refrence**. read and use fekar. [website](https://fakerphp.github.io/locales/en_IN/) 

### change default faker Locales:

Faker locale can be configured in the **config/app.php** configuration file. Just add the key faker_locale.

e.g.: 'faker_locale' => 'en_IN',

If any changes in local faker data collection import class file in **database/factories/YourFactory.php** and click(ctrl+click) this class .after click you go collection file and apply your changes,
